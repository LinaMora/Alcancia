...
public class Alcancia {
    ...
    public int calcularTotalDinero() {
        // TODO: Completar
        int total = (this.numeroMonedas50 * 50)+ (this.numeroMonedas100 *100) + (this.numeroMonedas200 *200)+ (this.numeroMonedas1000 *1000);
        return total;
    }
    ...
    public int obtenerDenominacionMasNumerosa() {
        int mayor = this.numeroMonedas50;
        int respuesta = 50;

        if (mayor<this.numeroMonedas100){
            mayor=this.numeroMonedas100;
            respuesta = 100;
        }
        if (mayor<this.numeroMonedas200){
            mayor=this.numeroMonedas200;
            respuesta = 200;
        }
        if (mayor<this.numeroMonedas500){
            mayor=this.numeroMonedas500;
            respuesta = 500;

        }
        if (mayor<this.numeroMonedas1000){
            mayor=this.numeroMonedas1000;
            respuesta = 1000;
        }
        return respuesta;
    }
